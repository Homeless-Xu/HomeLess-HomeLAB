...
WDS，即WindowsDeployment Services的缩写，中文含义为**Windows部署服务**
类似于Linux系统的PXE，可以用来批量部署Windows操作系统
...
3） 管理组件。包括WDS管理控制台和命令行工具，他们可以用于管理服务器，操作系统映像和客户端计算机帐户。利用WDS多播部署，可以将操作系统同时快速部署到多台计算机中，这个是绝对实用的功能。
